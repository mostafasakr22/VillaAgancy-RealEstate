 ...
 <header class="header-area header-sticky">
  ...
  <div class="page-heading header-text">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <span class="breadcrumb"><a href="#">{{ __('language.Home') }}</a>  /  {{ __('language.Single Property') }}</span>
          <h3>{{ __('language.Single Property') }}</h3>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingThree">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                  {{ __('language.Why is Villa the best ?') }}
                </button>
              </h2>
          ...
          <div class="info-table">
            <ul>
              <li>
                ...
                <h4>450 m2<br><span>{{ __('language.Total Flat Space') }}</span></h4>
              </li>
              <li>
                <img src={{ asset("images/info-icon-02.png") }} alt="" style="max-width: 52px;">
                <h4>Contract<br><span>{{ __('language.Contract Ready') }}</span></h4>
              </li>
              <li>
                <img src={{ asset("images/info-icon-03.png") }} alt="" style="max-width: 52px;">
                <h4>Payment<br><span>{{ __('language.Payment Process') }}</span></h4>
              </li>
              <li>
                <img src={{ asset("images/info-icon-04.png") }} alt="" style="max-width: 52px;">
                <h4>Safety<br><span>{{ __('language.24/7 Under Control') }}</span></h4>
              </li>
            </ul>
          </div>
        </div>
              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                  <div class="row">
                    <div class="col-lg-3">
                      <div class="info-table">
                        <ul>
                          <li>{{ __('language.Total Flat Space') }} <span>540 m2</span></li>
                          <li>{{ __('language.Floor number') }} <span>3</span></li>
                          <li>{{ __('language.Number of rooms') }} <span>8</span></li>
                    ...
                    <div class="col-lg-6">
                      <img src={{ asset("images/deal-01.jpg") }} alt="">
                    </div>
                    <div class="col-lg-3">
                      <h4>{{ __('language.All Info About Apartment') }}</h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, do eiusmod tempor pack incididunt ut labore et dolore magna aliqua quised ipsum suspendisse. <br><br>Swag fanny pack lyft blog twee. JOMO ethical copper mug, succulents typewriter shaman DIY kitsch twee taiyaki fixie hella venmo after messenger poutine next level humblebrag swag franzen.</p>
                      <div class="icon-button">
                        <a href="#"><i class="fa fa-calendar"></i> {{ __('language.Schedule a visit') }}</a>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      <img src={{ asset("images/deal-02.jpg") }} alt="">
                    </div>
                    <div class="col-lg-3">
                      <h4>{{ __('language.Detail Info About New Villa') }}</h4>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, do eiusmod tempor pack incididunt ut labore et dolore magna aliqua quised ipsum suspendisse. <br><br>Swag fanny pack lyft blog twee. JOMO ethical copper mug, succulents typewriter shaman DIY kitsch twee taiyaki fixie hella venmo after messenger poutine next level humblebrag swag franzen.</p>
                      <div class="icon-button">
                        <a href="#"><i class="fa fa-calendar"></i> {{ __('language.Schedule a visit') }}</a>
                      </div>
                    ...
                    <div class="col-lg-3">
                      <div class="info-table">
                        ...
                        <li>{{ __('language.Total Flat Space') }} <span>320 m2</span></li>
                          ...
                          <li>{{ __('langauge.Parking Available') }} <span>Yes</span></li>
                          <li>{{ __('language.Payment Process') }}<span>Bank</span></li>
                        </ul>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <img src={{ asset("images/deal-03.jpg") }} alt="">
                    </div>
                    <div class="col-lg-3">

      ...
      <div class="card">
        <div class="card-header bg-dark text-light d-flex justify-content-between align-items-center">
          <div style="font-size: large;">
            {{ __('language.Users') }} <!-- ترجمة "Users" -->
            <span class="badge badge-primary" style="font-size: 0.8rem;"> {{$user->count()}} </span>
          </div>
          <a href="{{ route('users.create') }}" class="btn btn-success">{{ __('language.Add New User') }}</a> <!-- ترجمة "Add New User" -->
        </div>
            ...
            <table class="table text-center">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th>{{ __('language.Age') }}</th> <!-- ترجمة "E-Mail" -->
                  <th>{{ __('language.Gender') }}</th> <!-- ترجمة "E-Mail" -->
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="d-flex justify-content-center">
                    ...
                    <a href="{{ route('users.edit', $item->id) }}" class="btn btn-primary mx-2">
